    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Record purchases here; each expense is deducted from your wallet balance.</p>
        </div>
        <div className="flex items-center gap-4">
          <div className="text-right">
            <p className="text-sm text-muted-foreground uppercase tracking-wider">This Month</p>
            <p className="text-2xl font-bold text-gradient">{formatJOD(currentMonthTotal)}</p>
          </div>
            ...
            <DialogContent className="glass-card border-white/10 sm:max-w-[425px]">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 pt-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input {...form.register('note')} className="bg-black/20 border-white/10" placeholder="e.g. Groceries at Whole Foods" />
                </div>
