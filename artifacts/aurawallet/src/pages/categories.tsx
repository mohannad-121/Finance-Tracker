    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {categories.map((cat) => {
          ...
          return (
            <div key={cat.id} className="p-5 rounded-2xl glass-card border border-white/5 relative group overflow-hidden hover:border-white/15 hover:-translate-y-0.5 transition-all duration-300">
              <div className={`absolute -right-10 -top-10 size-32 rounded-full ${cat.color} opacity-[0.07] blur-2xl group-hover:opacity-[0.14] transition-opacity`} />
