    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Manage your primary funds and balance.</p>
        </div>
          ...
          <Dialog open={isSubOpen} onOpenChange={setIsSubOpen}>
            ...
            <DialogContent className="glass-card border-white/10 sm:max-w-[425px]">
              ...
              <form onSubmit={subForm.handleSubmit(handleSub)} className="space-y-4 pt-4">
                ...
                <div className="space-y-2">
                  <Label>Note</Label>
                  <Input {...subForm.register('note')} className="bg-black/20 border-white/10" placeholder="e.g. ATM Withdrawal" />
                </div>
