      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="glass-card border-none bg-primary/5">
          <CardContent className="p-6">
            ...
            <h3 className="text-3xl font-bold text-emerald-400">{formatJOD(totalIncomeAllTime)}</h3>
          </CardContent>
        </Card>
        <Card className="glass-card border-none bg-destructive/5">
          <CardContent className="p-6">
            ...
            <h3 className="text-3xl font-bold text-destructive">{formatJOD(totalSpentAllTime)}</h3>
          </CardContent>
        </Card>
        <Card className="glass-card border-none bg-accent/5">
          <CardContent className="p-6">
            ...
            <h3 className="text-3xl font-bold text-accent">{formatJOD(walletBalance + totalUnpaidOwed)}</h3>
          </CardContent>
        </Card>
      </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    ...
                    <Tooltip 
                      contentStyle={{ backgroundColor: 'hsl(var(--card))', borderColor: 'rgba(255,255,255,0.1)', borderRadius: '12px' }}
                      itemStyle={{ color: 'hsl(var(--foreground))' }}
                      formatter={(value: number) => [formatJOD(value), 'Amount']}
                    />
                  </PieChart>
                </ResponsiveContainer>
              ) : (
